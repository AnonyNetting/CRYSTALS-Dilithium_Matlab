function intt_res = intt(a)
    ...
    % Perform INTT
    a = ntt(a, -1, N, g, mod_val);

    % Post-treat for negative wrapped convolution
    for i = 1:N
        intt_res(i) = mod(a(i) * qpow(qpow(g, mod_val-2, mod_val), i-1, mod_val), mod_val);
    end
